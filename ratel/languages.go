...
var LanguageCodes = []LanguageSpec{
	...
	{"alb", "sq", "Albanian", "albanais", "Albanisch"},
	...
	{"bod", "bo", "Tibetan", "tibétain", "Tibetisch"},
	...
	{"ces", "cs", "Czech", "tchèque", "Tschechisch"},
	...
	{"deu", "de", "German", "allemand", "Deutsch"},
	{"dgr", "", "Tlicho; Dogrib", "tlicho; dogrib", "Tlicho-Sprache; Dogrib-Sprache"},
	{"din", "", "Dinka", "dinka", "Dinka-Sprache"},
	{"div", "dv", "Divehi; Dhivehi; Maldivian", "maldivien", "Maledivisch"},
	{"doi", "", "Dogri (macrolanguage)", "dogri", "Dogri"},
	...
	{"ell", "el", "Greek, Modern (1453-)", "grec moderne (après 1453)", "Neugriechisch"},
	...
	{"fra", "fr", "French", "français", "Französisch"},
	...
	{"hye", "hy", "Armenian", "arménien", "Armenisch"},
	{"hye", "hy", "Armenian", "arménien", "Armenisch"},
	...
	{"isl", "is", "Icelandic", "islandais", "Isländisch"},
	...
	{"kat", "ka", "Georgian", "géorgien", "Georgisch"},
	...
	{"kok", "", "Konkani(macrolanguage)", "konkani", "Konkani"},
	...
	{"may", "", "Malay (macrolanguage)", "malais", "Malaiisch"},
	...
	{"mkd", "mk", "Macedonian", "macédonien", "Makedonisch"},
	{"mkd", "mk", "Macedonian", "macédonien", "Makedonisch"},
	...
	{"mri", "mi", "Maori", "maori", "Maori-Sprache"},
	{"msa", "ms", "Malay (macrolanguage)", "malais", "Malaiisch"},
	...
	{"mya", "my", "Burmese", "birman", "Birmanisch"},
	...
	{"nld", "nl", "Dutch; Flemish", "néerlandais; flamand", "Niederländisch"},
	...
	{"ron", "ro", "Romanian; Moldavian; Moldovan", "roumain; moldave", "Rumänisch"},
	...
	{"slk", "sk", "Slovak", "slovaque", "Slowakisch"},
	...
	{"sqi", "sq", "Albanian", "albanais", "Albanisch"},
	{"sqi", "sq", "Albanian", "albanais", "Albanisch"},
	...
	{"zho", "zh", "Chinese", "chinois", "Chinesisch"},
