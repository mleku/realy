...
func (in *TextField) Update(g Gx, th *Theme, col *Palette, hint string) {
	...
	var (
		...
		borderColor        = col.GetColor(co.DocText).NRGBA(128)
		borderColorHovered = col.GetColor(co.DocText).NRGBA(221)
		borderColorActive  = col.GetColor(co.DocText).NRGBA()
