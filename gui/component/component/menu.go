...
// MenuPage holds the state for a page demonstrating the features of
// the Menu component.
...
// New constructs a MenuPage with the provided router.
func New(router *Router) *MenuPage {
	return &MenuPage{
		Router: router,
	}
}
...
func (p *MenuPage) Actions() []component.AppBarAction {
	return []component.AppBarAction{}
}

func (p *MenuPage) Overflow() []component.OverflowAction {
	return []component.OverflowAction{}
}

func (p *MenuPage) NavItem() component.NavItem {
